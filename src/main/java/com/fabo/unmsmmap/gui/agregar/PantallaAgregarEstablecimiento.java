...
public class PantallaAgregarEstablecimiento {
	...
	public PantallaAgregarEstablecimiento() {
	...
	private void labelTitulo() {
		...
		tituloLabel2 = new JLabel("AGREGAR");
		tituloLabel2.setPreferredSize(new Dimension(190, 40));
